import { a as l, b as A, d as R } from "@nf-internal/chunk-4CLCTAJ7";
import { DOCUMENT as $n, Location as Jt } from "@angular/common";
import * as y from "@angular/core";
import { \u0275isPromise as zn, \u0275RuntimeError as E, computed as Fn, InjectionToken as ne, EventEmitter as Ye, input as qn, inject as g, ViewContainerRef as Hn, ChangeDetectorRef as Bn, reflectComponentType as Vn, runInInjectionContext as L, \u0275isInjectable as Gn, \u0275isNgModule as za, isStandalone as Fa, createEnvironmentInjector as Wn, Compiler as Qn, NgModuleFactory as Kn, afterNextRender as Yn, signal as Cr, EnvironmentInjector as Xt, DestroyRef as Zn, untracked as Oe, \u0275Console as Jn, \u0275PendingTasksInternal as Xn, \u0275INTERNAL_APPLICATION_ERROR_HANDLER as ei, \u0275formatRuntimeError as ti } from "@angular/core";
import { isObservable as Mr, from as V, of as v, BehaviorSubject as z, combineLatest as Tr, EmptyError as ri, Observable as ni, concat as ii, defer as er, pipe as oi, EMPTY as $, throwError as ai, Subject as Pt, Subscription as si } from "rxjs";
import { first as he, map as D, switchMap as H, take as Le, startWith as ci, filter as xe, takeUntil as Lt, mergeMap as ue, concatMap as Dr, tap as B, takeLast as Nr, catchError as _r, finalize as ui } from "rxjs/operators";
...
function li(t, n) { if (t.length !== n.length)
    ...
    if (!G(t[e], n[e]))
        return !1; return !0; }
function G(t, n) { let e = t ? jt(t) : void 0, r = n ? jt(n) : void 0; if (!e || !r || e.length != r.length)
...
function fe(t) { return Mr(t) ? t : zn(t) ? V(Promise.resolve(t)) : v(t); }
...
function gi(t, n) { return ce(t, n) && t.every((e, r) => G(e.parameters, n[r].parameters)); }
...
var Ii = /^[^=?&#]+/;
function Ai(t) { let n = t.match(Ii); return n ? n[0] : ""; }
var Ei = /^[^&#]+/;
function Mi(t) { let n = t.match(Ei); return n ? n[0] : ""; }
var zt = class {
    url;
    remaining;
    ...
    parseChildren(n = 0) { if (n > 50)
        throw new E(4010, !1); if (this.remaining === "")
    ...
    parseSegment() { let n = _t(this.remaining); if (n === "" && this.peekStartsWith(";"))
        throw new E(4009, !1); return this.capture(n), new ee(tt(n), this.parseMatrixParams()); }
...
var it = class {
    ...
    constructor(n, e, r) { if (this.isAbsolute = n, this.numberOfDoubleDots = e, this.commands = r, n && r.length > 0 && nt(r[0]))
        throw new E(4003, !1); let i = r.find(ke); if (i && i !== di(r))
        throw new E(4004, !1); }
...
function Ir(t, n, e) { return t == e.path && G(n, e.parameters); }
...
function Ut(t) { if (t.snapshot) {
    ...
    t.snapshot = e, G(n.queryParams, e.queryParams) || t.queryParamsSubject.next(e.queryParams), n.fragment !== e.fragment && t.fragmentSubject.next(e.fragment), G(n.params, e.params) || t.paramsSubject.next(e.params), li(n.url, e.url) || t.urlSubject.next(e.url), G(n.data, e.data) || t.dataSubject.next(e.data);
}
else
    t.snapshot = t._futureSnapshot, t.dataSubject.next(t._futureSnapshot.data); }
function Bt(t, n) { let e = G(t.params, n.params) && gi(t.url, n.url), r = !t.parent != !n.parent; return e && !r && (!t.parent || Bt(t.parent, n.parent)); }
...
var Jr = new ne(""), ar = (() => { class t {
    ...
    get component() { if (!this.activated)
        throw new E(4012, !1); return this.activated.instance; }
    get activatedRoute() { if (!this.activated)
        throw new E(4012, !1); return this._activatedRoute; }
    get activatedRouteData() { return this._activatedRoute ? this._activatedRoute.snapshot.data : {}; }
    detach() { if (!this.activated)
        throw new E(4012, !1); this.location.detach(); let e = this.activated; return this.activated = null, this._activatedRoute = null, this.detachEvents.emit(e.instance), e; }
    ...
    subscribeToRouteData(e) { let { activatedRoute: r } = e, i = Tr([r.queryParams, r.params, r.data]).pipe(H(([o, s, a], c) => (a = l(l(l({}, o), s), a), c === 0 ? v(a) : Promise.resolve(a)))).subscribe(o => { if (!e.isActivated || !e.activatedComponentRef || e.activatedRoute !== r || r.component === null) {
...
function ur(t) { let n = t.children && t.children.map(ur), e = n ? A(l({}, t), { children: n }) : l({}, t); return !e.component && !e.loadComponent && (n || e.loadChildren) && e.outlet && e.outlet !== p && (e.component = cr), e; }
...
function Bi(t, n, e) { if (typeof e == "function")
    ...
    case "pathParamsOrQueryParamsChange": return !ce(t.url, n.url) || !G(t.queryParams, n.queryParams);
    case "always": return !0;
    case "paramsOrQueryParamsChange": return !Bt(t, n) || !G(t.queryParams, n.queryParams);
...
function Ee() { return H(t => Tr(t.map(n => n.pipe(Le(1), ci(Je)))).pipe(D(n => { for (let e of n)
    if (e !== !0) {
        if (e === Je)
            return Je;
        if (e === !1 || Zi(e))
...
function Zi(t) { return te(t) || t instanceof Ae; }
...
function Ji(t) { return ue(n => { let { targetSnapshot: e, currentSnapshot: r, guards: { canActivateChecks: i, canDeactivateChecks: o } } = n; return o.length === 0 && i.length === 0 ? v(A(l({}, n), { guardsResult: !0 })) : Xi(o, e, r).pipe(ue(s => s && Vi(s) ? eo(e, i, t) : v(s)), D(s => A(l({}, n), { guardsResult: s }))); }); }
function Xi(t, n, e) { return V(t).pipe(ue(r => oo(r.component, r.route, e, n)), he(r => r !== !0, !0)); }
function eo(t, n, e) { return V(n).pipe(Dr(r => ii(ro(r.route.parent, e), to(r.route, e), io(t, r.path), no(t, r.route))), he(r => r !== !0, !0)); }
...
function no(t, n) { let e = n.routeConfig ? n.routeConfig.canActivate : null; if (!e || e.length === 0)
    return v(!0); let r = e.map(i => er(() => { let o = n._environmentInjector, s = Me(i, o), a = Wi(s) ? s.canActivate(n, t) : L(o, () => s(n, t)); return fe(a).pipe(he()); })); return v(r).pipe(Ee()); }
function io(t, n) { let e = n[n.length - 1], i = n.slice(0, n.length - 1).reverse().map(o => qi(o)).filter(o => o !== null).map(o => er(() => { let s = o.guards.map(a => { let c = o.node._environmentInjector, u = Me(a, c), h = Qi(u) ? u.canActivateChild(e, t) : L(c, () => u(e, t)); return fe(h).pipe(he()); }); return v(s).pipe(Ee()); })); return v(i).pipe(Ee()); }
function oo(t, n, e, r) { let i = n && n.routeConfig ? n.routeConfig.canDeactivate : null; if (!i || i.length === 0)
    return v(!0); let o = i.map(s => { let a = n._environmentInjector, c = Me(s, a), u = Ki(c) ? c.canDeactivate(t, n, e, r) : L(a, () => c(t, n, e, r)); return fe(u).pipe(he()); }); return v(o).pipe(Ee()); }
function ao(t, n, e, r, i) { let o = n.canLoad; if (o === void 0 || o.length === 0)
    return v(!0); let s = o.map(a => { let c = Me(a, t), u = Gi(c) ? c.canLoad(n, e) : L(t, () => c(n, e)), h = fe(u); return i ? h.pipe(on(i)) : h; }); return v(s).pipe(Ee(), an(r)); }
function an(t) { return oi(B(n => { if (typeof n != "boolean")
    throw mt(t, n); }), D(n => n === !0)); }
function so(t, n, e, r, i, o) { let s = n.canMatch; if (!s || s.length === 0)
    return v(!0); let a = s.map(c => { let u = Me(c, t), h = Yi(u) ? u.canMatch(n, e, i) : L(t, () => u(n, e, i)); return fe(h).pipe(on(o)); }); return v(a).pipe(Ee(), an(r)); }
...
function co(t) { throw new E(4e3, !1); }
...
function W(t) { return t.outlet || p; }
function fo(t, n) { let e = t.filter(r => W(r) === n); return e.push(...t.filter(r => W(r) !== n)), e; }
...
function Ar(t, n, e, r) { return e.length > 0 && mo(t, e, r) ? { segmentGroup: new m(n, vo(r, new m(e, t.children))), slicedSegments: [] } : e.length === 0 && yo(t, e, r) ? { segmentGroup: new m(t.segments, go(t, e, r, t.children)), slicedSegments: e } : { segmentGroup: new m(t.segments, t.children), slicedSegments: e }; }
...
function mo(t, n, e) { return e.some(r => Ct(t, n, r) && W(r) !== p); }
...
var So = 31, Yt = class {
    ...
    noMatchError(n) { return new E(4002, `'${n.segmentGroup}'`); }
    recognize() { return R(this, null, function* () { let n = Ar(this.urlTree.root, [], [], this.config).segmentGroup, { children: e, rootSnapshot: r } = yield this.match(n), i = new U(r, e), o = new Fe("", i), s = Br(r, [], this.urlTree.queryParams, this.urlTree.fragment); return s.queryParams = this.urlTree.queryParams, o.url = this.urlSerializer.serialize(s), { state: o, tree: s }; }); }
    ...
    processSegmentAgainstRoute(n, e, r, i, o, s, a, c) { return R(this, null, function* () { if (W(r) !== s && (s === p || !Ct(i, o, r)))
    ...
    createSnapshot(n, e, r, i, o) { let s = new Ie(r, i, Object.freeze(l({}, this.urlTree.queryParams)), this.urlTree.fragment, Io(e), W(e), e.component ?? e._loadedComponent ?? null, e, Ao(e), n), a = ir(s, o, this.paramsInheritanceStrategy); return s.params = Object.freeze(a.params), s.data = Object.freeze(a.data), s; }
    matchSegmentAgainstRoute(n, e, r, i, o, s) { return R(this, null, function* () { if (this.abortSignal.aborted)
        ...
        throw new Y(e); n = r._injector ?? n; let { routes: u } = yield this.getChildConfig(n, r, i), h = r._loadedInjector ?? n, { parameters: f, consumedSegments: S, remainingSegments: K } = c, j = this.createSnapshot(n, r, S, f, s), { segmentGroup: I, slicedSegments: k } = Ar(e, S, K, u); if (k.length === 0 && I.hasChildren()) {
        let ge = yield this.processChildren(h, u, I, j);
        return new U(j, ge);
    } if (u.length === 0 && k.length === 0)
        return new U(j, []); let De = W(r) === o, se = yield this.processSegment(h, u, I, k, De ? p : o, !0, j); return new U(j, se instanceof U ? [se] : []); }); }
...
function Eo(t, n, e, r, i, o, s) { return ue(a => R(null, null, function* () { let { state: c, tree: u } = yield Co(t, n, e, r, a.extractedUrl, i, o, s); return A(l({}, a), { targetSnapshot: c, urlAfterRedirects: u }); })); }
function Mo(t) { return ue(n => { let { targetSnapshot: e, guards: { canActivateChecks: r } } = n; if (!r.length)
    ...
    if (!o.has(a))
        for (let c of ln(a))
            o.add(c); let s = 0; return V(o).pipe(Dr(a => i.has(a) ? To(a, e, t) : (a.data = ir(a, a.parent, t).resolve, v(void 0))), B(() => s++), Nr(1), ue(a => s === o.size ? v(n) : $)); }); }
...
function Do(t, n, e) { let r = jt(t); if (r.length === 0)
    return v({}); let i = {}; return V(r).pipe(ue(o => No(t[o], n, e).pipe(he(), B(s => { if (s instanceof Ae)
...
function Er(t) { return H(n => { let e = t(n); return e ? V(e).pipe(D(() => n)) : v(n); }); }
var lr = (() => { class t {
...
var Po = () => { }, bt = new ne(""), It = (() => { class t {
    ...
    handleNavigationRequest(e) { let r = ++this.navigationId; Oe(() => { this.transitions?.next(A(l({}, e), { extractedUrl: this.urlHandlingStrategy.extract(e.rawUrl), targetSnapshot: null, targetRouterState: null, guards: { canActivateChecks: [], canDeactivateChecks: [] }, guardsResult: null, id: r, routesRecognizeHandler: {}, beforeActivateHandler: {} })); }); }
    setupNavigations(e) { return this.transitions = new z(null), this.transitions.pipe(xe(r => r !== null), H(r => { let i = !1, o = new AbortController, s = () => !i && this.currentTransition?.id === r.id; return v(r).pipe(H(a => { if (this.navigationId > r.id)
        return this.cancelNavigationTransition(r, "", b.SupersededByNewNavigation), $; this.currentTransition = r; let c = this.lastSuccessfulNavigation(); this.currentNavigation.set({ id: a.id, initialUrl: a.rawUrl, extractedUrl: a.extractedUrl, targetBrowserUrl: typeof a.extras.browserUrl == "string" ? this.urlSerializer.parse(a.extras.browserUrl) : a.extras.browserUrl, trigger: a.source, extras: a.extras, previousNavigation: c ? A(l({}, c), { previousNavigation: null }) : null, abort: () => o.abort(), routesRecognizeHandler: a.routesRecognizeHandler, beforeActivateHandler: a.beforeActivateHandler }); let u = !e.navigated || this.isUpdatingInternalState() || this.isUpdatedBrowserUrl(), h = a.extras.onSameUrlNavigation ?? e.onSameUrlNavigation; if (!u && h !== "reload")
        return this.events.next(new F(a.id, this.urlSerializer.serialize(a.rawUrl), "", Ce.IgnoredSameUrlNavigation)), a.resolve(!1), $; if (this.urlHandlingStrategy.shouldProcessUrl(a.rawUrl))
        return v(a).pipe(H(f => (this.events.next(new J(f.id, this.urlSerializer.serialize(f.extractedUrl), f.source, f.restoredState)), f.id !== this.navigationId ? $ : Promise.resolve(f))), Eo(this.environmentInjector, this.configLoader, this.rootComponentType, e.config, this.urlSerializer, this.paramsInheritanceStrategy, o.signal), B(f => { r.targetSnapshot = f.targetSnapshot, r.urlAfterRedirects = f.urlAfterRedirects, this.currentNavigation.update(S => (S.finalUrl = f.urlAfterRedirects, S)), this.events.next(new we); }), H(f => V(r.routesRecognizeHandler.deferredHandle ?? v(void 0)).pipe(D(() => f))), B(() => { let f = new $e(a.id, this.urlSerializer.serialize(a.extractedUrl), this.urlSerializer.serialize(a.urlAfterRedirects), a.targetSnapshot); this.events.next(f); })); if (u && this.urlHandlingStrategy.shouldProcessUrl(a.currentRawUrl)) {
        ...
        return this.currentTransition = r = A(l({}, a), { targetSnapshot: De, urlAfterRedirects: S, extras: A(l({}, I), { skipLocationChange: !1, replaceUrl: !1 }) }), this.currentNavigation.update(se => (se.finalUrl = S, se)), v(r);
    }
    else
        return this.events.next(new F(a.id, this.urlSerializer.serialize(a.extractedUrl), "", Ce.IgnoredByUrlHandlingStrategy)), a.resolve(!1), $; }), D(a => { let c = new ot(a.id, this.urlSerializer.serialize(a.extractedUrl), this.urlSerializer.serialize(a.urlAfterRedirects), a.targetSnapshot); return this.events.next(c), this.currentTransition = r = A(l({}, a), { guards: Fi(a.targetSnapshot, a.currentSnapshot, this.rootContexts) }), r; }), Ji(a => this.events.next(a)), H(a => { if (r.guardsResult = a.guardsResult, a.guardsResult && typeof a.guardsResult != "boolean")
        ...
        return $; let h = !1; return v(a).pipe(Mo(this.paramsInheritanceStrategy), B({ next: () => { h = !0; let f = new ct(a.id, this.urlSerializer.serialize(a.extractedUrl), this.urlSerializer.serialize(a.urlAfterRedirects), a.targetSnapshot); this.events.next(f); }, complete: () => { h || this.cancelNavigationTransition(a, "", b.NoDataFromResolver); } })); }), Er(a => { let c = h => { let f = []; if (h.routeConfig?._loadedComponent)
        ...
        f.push(...c(S)); return f; }, u = c(a.targetSnapshot.root); return u.length === 0 ? v(a) : V(Promise.all(u).then(() => a)); }), Er(() => this.afterPreactivation()), H(() => { let { currentSnapshot: a, targetSnapshot: c } = r, u = this.createViewTransition?.(this.environmentInjector, a.root, c.root); return u ? V(u).pipe(D(() => r)) : v(r); }), Le(1), H(a => { let c = ji(e.routeReuseStrategy, a.targetSnapshot, a.currentRouterState); this.currentTransition = r = a = A(l({}, a), { targetRouterState: c }), this.currentNavigation.update(h => (h.targetRouterState = c, h)), this.events.next(new de); let u = r.beforeActivateHandler.deferredHandle; return u ? V(u.then(() => a)) : v(a); }), B(a => { new Gt(e.routeReuseStrategy, r.targetRouterState, r.currentRouterState, c => this.events.next(c), this.inputBindingEnabled).activate(this.rootContexts), s() && (i = !0, this.currentNavigation.update(c => (c.abort = Po, c)), this.lastSuccessfulNavigation.set(Oe(this.currentNavigation)), this.events.next(new N(a.id, this.urlSerializer.serialize(a.extractedUrl), this.urlSerializer.serialize(a.urlAfterRedirects))), this.titleStrategy?.updateTitle(a.targetRouterState.snapshot), a.resolve(!0)); }), Lt(nn(o.signal).pipe(xe(() => !i && !r.targetRouterState), B(() => { this.cancelNavigationTransition(r, o.signal.reason + "", b.Aborted); }))), B({ complete: () => { i = !0; } }), Lt(this.transitionAbortWithErrorSubject.pipe(B(a => { throw a; }))), ui(() => { o.abort(), i || this.cancelNavigationTransition(r, "", b.SupersededByNewNavigation), this.currentTransition?.id === r.id && (this.currentNavigation.set(null), this.currentTransition = null); }), _r(a => { if (i = !0, this.destroyed)
...
function At(t, n) { t.events.pipe(xe(e => e instanceof N || e instanceof M || e instanceof re || e instanceof F), D(e => e instanceof N || e instanceof F ? 0 : (e instanceof M ? e.code === b.Redirect || e.code === b.SupersededByNewNavigation : !1) ? 2 : 1), xe(e => e !== 2), Le(1)).subscribe(() => { n(); }); }
var q = (() => { class t {
...
var la = (() => { class t {
    ...
    static \u0275fac = function (r) { return new (r || t)(d.\u0275\u0275directiveInject(q), d.\u0275\u0275directiveInject(Q), d.\u0275\u0275injectAttribute("tabindex"), d.\u0275\u0275directiveInject(d.Renderer2), d.\u0275\u0275directiveInject(d.ElementRef), d.\u0275\u0275directiveInject(Cn.LocationStrategy)); };
    ...
    subscribeToEachLinkOnChanges() { this.linkInputChangesSubscription?.unsubscribe(); let e = [...this.links.toArray(), this.link].filter(r => !!r).map(r => r.onChanges); this.linkInputChangesSubscription = Et(e).pipe(Mt()).subscribe(r => { this._isActive !== this.isLinkActive(this.router)(r) && this.update(); }); }
...
var We = class {
    ...
    preloadConfig(e, r) { return this.preloadingStrategy.preload(r, () => { if (e.destroyed)
        return ae(null); let i; r.loadChildren && r.canLoad === void 0 ? i = Et(this.loader.loadChildren(e, r)) : i = ae(null); let o = i.pipe(ua(s => s === null ? ae(void 0) : (r._loadedRoutes = s.routes, r._loadedInjector = s.injector, r._loadedNgModuleFactory = s.factory, this.processRoutes(s.injector ?? e, s.routes)))); if (r.loadComponent && !r._loadedComponent) {
        let s = this.loader.loadComponent(e, r);
        return Et([o, s]).pipe(Mt());
    }
    else
        return o; }); }
    static \u0275fac = function (r) { return new (r || t)(d.\u0275\u0275inject(q), d.\u0275\u0275inject(d.EnvironmentInjector), d.\u0275\u0275inject(We), d.\u0275\u0275inject(St)); };
    static \u0275prov = d.\u0275\u0275defineInjectable({ token: t, factory: t.\u0275fac, providedIn: "root" });
...
var ga = (() => { class t extends Te {
    ...
    handleRouterEvent(e, r) { return R(this, null, function* () { if (this.currentNavigation = A(l({}, this.currentNavigation), { routerTransition: r }), e instanceof J)
    ...
    navigate(e, r) { let i = r.extras.skipLocationChange ? this.navigation.currentEntry.url : this.location.prepareExternalUrl(e), o = A(l({}, r.extras.state), { navigationId: r.id }), s = { \u0275routerInfo: { intercept: !0 } }; !this.navigation.transition && this.currentNavigation.navigationEvent && (r.extras.replaceUrl = !1); let a = this.location.isCurrentPathEqualTo(i) || r.extras.replaceUrl || r.extras.skipLocationChange ? "replace" : "push"; gr(this.navigation.navigate(i, { state: o, history: a, info: s })); }
    ...
    handleNavigate(e) { if (!e.canIntercept || e.navigationType === "reload")
        ...
        this.currentNavigation.commitUrl = () => R(this, null, function* () { this.currentNavigation.commitUrl = void 0; let I = this.currentNavigation.routerTransition; if (I && !I.extras.skipLocationChange) {
            let k = this.createBrowserPath(I), De = this.location.isCurrentPathEqualTo(k) || I.extras.replaceUrl ? "replace" : "push", se = A(l({}, I.extras.state), { navigationId: I.id }), ge = this.location.prepareExternalUrl(k);
...
function Dn() { return C(q).routerState.root; }
...
function Nn() { let t = C(En); return n => { let e = t.get(oa); if (n !== e.components[0])
    return; let r = t.get(q), i = t.get(_n); t.get(Rr) === 1 && r.initialNavigation(), t.get(Pn, null, { optional: !0 })?.setUpPreloading(), t.get(Dt, null, { optional: !0 })?.init(), r.resetRootComponentType(e.componentTypes[0]), i.closed || (i.next(), i.complete(), i.unsubscribe()); }; }
var _n = new Qe("", { factory: () => new yr }), Rr = new Qe("", { factory: () => 1 });
function On() { let t = [{ provide: na, useValue: !0 }, { provide: Rr, useValue: 0 }, An(() => { let n = C(En); return n.get(Ho, Promise.resolve()).then(() => new Promise(r => { let i = n.get(q), o = n.get(_n); At(i, () => { r(!0); }), n.get(It).afterPreactivation = () => (r(!0), o.closed ? ae(void 0) : o), i.initialNavigation(); })); })]; return x(2, t); }
function Un() { let t = [An(() => { C(q).setUpLocationChangeListener(); }), { provide: Rr, useValue: 2 }]; return x(3, t); }
...
var kn = [wn, { provide: ie, useClass: Z }, q, pe, { provide: Q, useFactory: Dn }, St, []], Aa = (() => { class t {
    constructor() { }
    static forRoot(e, r) { return { ngModule: t, providers: [kn, [], { provide: oe, multi: !0, useValue: e }, [], r?.errorHandler ? { provide: bt, useValue: r.errorHandler } : [], { provide: X, useValue: r || {} }, r?.useHash ? Ma() : Ta(), Ea(), r?.preloadingStrategy ? Ln(r.preloadingStrategy).\u0275providers : [], r?.initialNavigation ? Da(r) : [], r?.bindToComponentInputs ? xn().\u0275providers : [], r?.enableViewTransitions ? jn().\u0275providers : [], Na()] }; }
...
function Ea() { return { provide: Dt, useFactory: () => { let t = C(Sn), n = C(X); return n.scrollOffset && t.setOffset(n.scrollOffset), new Tn(n); } }; }
