...
import { Version as E, ViewEncapsulation as O, Injector as R, Compiler as p, createPlatformFactory as y, COMPILER_OPTIONS as l, CompilerFactory as I } from "@angular/core";
...
var L = new E("21.2.6"), _ = [{ provide: p, useFactory: () => new p }], u = class {
    _defaultOptions;
    constructor(t) { let r = { defaultEncapsulation: O.Emulated }; this._defaultOptions = [r, ...t]; }
    createCompiler(t = []) { let r = w(this._defaultOptions.concat(t)); return R.create({ providers: [_, { provide: d, useFactory: () => new d({ defaultEncapsulation: r.defaultEncapsulation, preserveWhitespaces: r.preserveWhitespaces }), deps: [] }, r.providers] }).get(p); }
};
