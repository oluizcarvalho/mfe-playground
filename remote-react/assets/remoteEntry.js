...
"./App":()=>{
      ...
      return __federation_import('/mfe-playground/remote-react/assets/__federation_expose_App-D4EFGmUW.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
      const dynamicLoadingCss = (cssFilePaths, dontAppendStylesToHead, exposeItemName) => {
        ...
        const base = '/mfe-playground/remote-react/';
        'assets';
        ...
        cssFilePaths.forEach(cssPath => {
         ...
         if (baseUrl) {
          ...
          if (dontAppendStylesToHead) {
            const key = 'css__remote-react__' + exposeItemName;
